 ...
 * @description: 隐式
 */
public class ImplicitAuthenticationProvider extends AbstractAccessTokenProvider {

    public ImplicitAuthenticationProvider(RedisCache redisCache, TokenGranter tokenGranter, OAuth2RequestFactory requestFactory, AuthorizationTenantService authorizationTenantService) {
    ...
    public boolean supports(Class<?> authentication) {
        return ImplicitAuthenticationModel.class.isAssignableFrom(authentication);
    }
}